module "work_eco_central_stage_request" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "work-eco-central-stage@grendel-consulting.com" # Google Groups, must be unique
    AccountName               = "work-eco-central-stage"
  ...
  change_management_parameters = {
    ...
    change_reason       = "Staging Data Ecosystem Central Governance"
  }
